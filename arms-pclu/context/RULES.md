...
- **Faculty Submissions Actions ("My Submissions")**: In the Faculty Portal under "My Submissions", "Edit Tags / Resume" is always accessible to faculty for managing mappings and resuming drafts. "Archive Document" is removed from "My Submissions" because document archiving and lifecycle archives are managed within the "Approved Repository" tab.
