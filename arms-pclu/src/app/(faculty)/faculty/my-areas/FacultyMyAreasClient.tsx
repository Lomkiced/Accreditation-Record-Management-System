...
import type { getAssignmentsForFaculty } from "@/actions/assignment.actions"
import type { getAreas } from "@/actions/area.actions"
import type { getMySubmissions } from "@/actions/submission.actions"

type InitialData = {
  assignments: Extract<Awaited<ReturnType<typeof getAssignmentsForFaculty>>, { success: true }>["data"]
  areas: Extract<Awaited<ReturnType<typeof getAreas>>, { success: true }>["data"]
