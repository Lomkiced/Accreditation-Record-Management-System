...
import type { getTagsWithUsage } from "@/actions/tag.actions"

type TagsData = NonNullable<Extract<Awaited<ReturnType<typeof getTagsWithUsage>>, { success: true }>["data"]>

export function AdminTagsClient({ initialData }: { initialData: TagsData }) {
  ...
  const { data: tags = [], isLoading } = useTagManagement(initialData)
